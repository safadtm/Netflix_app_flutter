...
mixin _$DownloadsState {
  ...
  List<DownloadsImage>? get downloads => throw _privateConstructorUsedError;
  Option<Either<MainTitle, List<DownloadsImage>>>
    ...
    return _then(_value.copyWith(
      ...
      downloadsFailureOrSuccessOption: downloadsFailureOrSuccessOption ==
          ...
          : downloadsFailureOrSuccessOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainTitle, List<DownloadsImage>>>,
    ));
  }
}
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      final List<DownloadsImage>? downloads,
      required this.downloadsFailureOrSuccessOption})
      : _downloads = downloads;

  @override
  final bool isLoading;
  final List<DownloadsImage>? _downloads;
  @override
  List<DownloadsImage>? get downloads {
  ...
  @override
  final Option<Either<MainTitle, List<DownloadsImage>>>
      downloadsFailureOrSuccessOption;
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      final List<DownloadsImage>? downloads,
      required final Option<Either<MainTitle, List<DownloadsImage>>>
